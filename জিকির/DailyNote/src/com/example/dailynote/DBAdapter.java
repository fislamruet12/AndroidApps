...
public void  close()
{
  ...
  public ArrayList<DbInsertingClass> getAllAdvance() {
     ...
     public void updateDbtasbiah(String val,long id)
     {
    	 ContentValues values =new ContentValues();
    	 
    	 values.put(DBHelper.E_TAKA,val);
    	 db.update(DBHelper.EARN, values, DBHelper.E_ID+" = ?",new String[]{String.valueOf(id)});
    	 
     }
     public void updateDbname(String TableName,String name,String val,long id)
     {
    	 ContentValues values =new ContentValues();
    	 values.put(DBHelper.L_NAME,name);
    	 values.put(DBHelper.L_TAKA,val);
    	 db.update(TableName, values, DBHelper.E_ID+" = ?",new String[]{String.valueOf(id)});
